                ...
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="10000">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5 class="h">Makoto Yuki</h5>
                            <p class="h">Um aluno do segundo ano que se transferiu para a Gekkoukan High School na primavera, retornando
                                <br>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5 class="h">Junpei Iori</h5>
                            <p class="h">Outro colega do Protagonista, ao lado de Yukari. Ele desperta para suas habilidades de Persona logo após 
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5 class="h">Akihiko Sanada</h5>
                            <p class="h">Aluno do terceiro ano da Gekkoukan High School e um dos membros fundadores da S.E.E.S.
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5 class="h">Koromaru</h5>
                            <p class="h">Um cachorro que desperta para o poder da Persona após um acontecimento trágico.
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5 class="h">Ken Amada</h5>
                            <p class="h">O membro mais jovem do SEES um aluno da 5ª série da Gekkoukan Elementary. Depois de 
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5 class="h">Shinjiro Aragaki</h5>
                            <p class="h">Um terceiro ano na Gekkoukan High, embora raramente possa ser visto na escola.
